...
6. **Port core logic verbatim.** This is a *typed rewrite* of `@ideaportriga/nexus-bridge` + `@ideaportriga/nexus-factory`. Do not change runtime behaviour. Only types and structure change.
